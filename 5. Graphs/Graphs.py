...
# You can sometimes get by with just a list of edges, since edges 
# contain references to the nodes they connect to, or vice versa. 
# However, our Graph class is built with both for the following reasons

# If you're storing a disconnected graph, not every 
# node will be tied to an edge, so you should store 
# a list of nodes.
...
# each value is unique, but we need to be careful about keeping both nodes and edges 
